...
import kotlinx.android.synthetic.main.layout_event_code_field.*
...
//    }
    ...
    private fun setupCodeEntrySheet() {
        val bottomSheetBehavior = BottomSheetBehavior.from(codeEntrySheet)
        ...
        bottomSheetBehavior.setBottomSheetCallback(object : BottomSheetBehavior.BottomSheetCallback() {
            ...
            override fun onStateChanged(view: View, state: Int) {
                when (state) {
                    BottomSheetBehavior.STATE_HIDDEN -> code_entry_fab.show()
                    BottomSheetBehavior.STATE_EXPANDED -> code_entry_fab.hide()
                }
            }
        })
    }
