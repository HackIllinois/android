...
public class MagicTextView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    public void init(AttributeSet attrs){
        ...
        if(attrs != null){
            ...
            if(a.hasValue(R.styleable.MagicTextView_magicForeground)){
                Drawable foreground = a.getDrawable(R.styleable.MagicTextView_magicForeground);
                if(foreground != null){
                    this.setForegroundDrawable(foreground);
                }else{
                    this.setTextColor(a.getColor(R.styleable.MagicTextView_magicForeground, 0xff000000));
                }
            }
