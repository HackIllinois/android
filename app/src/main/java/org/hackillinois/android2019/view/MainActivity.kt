...
import org.hackillinois.android2019.view.admin.AdminFragment
import org.hackillinois.android2019.view.home.HomeFragment
import org.hackillinois.android2019.view.schedule.ScheduleFragment
import org.hackillinois.android2019.viewmodel.MainViewModel
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
     ...
     */
    private fun updateRoles(roles: Roles?) = roles?.roles?.let { listOfRoles ->
        if (listOfRoles.contains("Admin")) {
            navAdmin.visibility = View.VISIBLE
            navScanner.visibility = View.VISIBLE
        } else if (listOfRoles.contains("Staff")) {
            navScanner.visibility = View.VISIBLE
        } else {
            navScanner.visibility = View.GONE
