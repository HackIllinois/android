...
class ScheduleViewModel : ViewModel() {
    ...
    lateinit var fridayEventsLiveData: LiveData<List<org.hackillinois.androidapp2019.database.entity.Event>>
    lateinit var saturdayEventsLiveData: LiveData<List<org.hackillinois.androidapp2019.database.entity.Event>>
    lateinit var sundayEventsLiveData: LiveData<List<org.hackillinois.androidapp2019.database.entity.Event>>
